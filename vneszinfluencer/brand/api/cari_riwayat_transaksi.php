<?php
  ...
  $sql = "SELECT * FROM tabel_progress_project WHERE nama_project LIKE '%".$_POST['cari_transaksi']."%' AND nama_brand='".$_POST['nama_brand']."' AND status_project='Dibayar' order by waktu_pembayaran desc";
