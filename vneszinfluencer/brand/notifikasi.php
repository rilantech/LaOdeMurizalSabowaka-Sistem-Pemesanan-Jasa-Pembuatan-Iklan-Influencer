...
$pesan_status_hapus_data ='';
    ...
    if(isset($_SESSION['jumlah_notifikasi'])){
        unset($_SESSION['jumlah_notifikasi']);
    }
...
if(isset($_POST['cari_notifikasi'])){
    ...
    $notifikasi = mysqli_query($db, "SELECT * FROM tabel_notifikasi where waktu_notif LIKE '%".$_POST['cari_notifikasi']."%' AND nama_brand='".$akun_brand['nama_brand']."' ORDER by waktu_notif DESC limit $halaman_awal, $batas");
    ...
    $notifikasi = mysqli_query($db, "SELECT * FROM tabel_notifikasi where nama_brand='".$akun_brand['nama_brand']."' ORDER by waktu_notif DESC limit $halaman_awal, $batas");
    $nomor = $halaman_awal+1;
}
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?= $data_notifikasi['nama_influencer']; ?></td>
