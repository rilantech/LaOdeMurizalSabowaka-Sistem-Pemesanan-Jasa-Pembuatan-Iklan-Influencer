...
<head>
    <meta charset="utf-8">
    <title>VnesZBrand|Detail Transaksi</title>
            ...
            <h4 class="mb-3"><span>Detail Riwayat Transaksi</span></h4>
                ...
                <div class="row justify-content center">
                    <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image">p</div> -->
                     ...
                     <img class="w-100" src="gambar/<?= $data_progress_project['struk_bukti_pembayaran'];?>" alt=""  height="300">
                     <button type="button" class="btn btn-warning rounded w-100 mb-3 mt-3" style="font-size: 15px;font-weight:bold;" onclick="window.location='gambar/<?= $data_progress_project['struk_bukti_pembayaran'];?>';" target="_blank"><i class="fa fa-zoom"></i> Perbesar</button>
                     </div>
                     ...
                     <table class="table table-bordered text-left text-dark mt-small-3" style="height: 300px;">
                        ...
                        <tr>
                            ...
                            <th>:</th>
                            <td><?= $data_progress_project['nama_influencer'];?></td>
                        </tr>
                        <tr>
                            <th>Jumlah Gaji</th>
                            <th>:</th>
