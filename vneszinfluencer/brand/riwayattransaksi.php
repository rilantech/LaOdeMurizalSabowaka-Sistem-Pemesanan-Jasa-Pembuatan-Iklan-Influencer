...
if(isset($_POST['cari_transaksi'])){
    ...
    $riwayattransaksi = mysqli_query($db, "SELECT * FROM tabel_progress_project where nama_project LIKE '%".$_POST['cari_transaksi']."%' AND nama_brand='".$akun_brand['nama_brand']."' AND status_project='Dibayar' ORDER by waktu_pembayaran DESC limit $halaman_awal, $batas");
    ...
    $riwayattransaksi = mysqli_query($db, "SELECT * FROM tabel_progress_project where nama_brand='".$akun_brand['nama_brand']."' AND status_project='Dibayar' ORDER by waktu_pembayaran DESC limit $halaman_awal, $batas");
    $nomor = $halaman_awal+1;
}
...
<head>
    <meta charset="utf-8">
    <title>VnesZBrand|Riwayat Transaksi</title>
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><img src="gambar/<?= $data_progress_project['struk_bukti_pembayaran']; ?>" alt="" width="100" height="100"></td>
