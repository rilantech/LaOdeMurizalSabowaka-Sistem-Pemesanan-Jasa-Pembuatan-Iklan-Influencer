<?php
  ...
  if ($foto_profil!= "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
      ...
      $query = "INSERT INTO tabel_akun_brand (nama_brand, username, password, foto_profil, email, nomor_telepon) VALUES ('$nama_brand', '$username', '$password', '$foto_profil', '$email', '$nomor_telepon')";
      ...
      $select = "INSERT INTO tabel_akun_brand (nama_brand, username, password, email, nomor_telepon) VALUES ('$nama_brand', '$username', '$password', '$email', '$nomor_telepon')";
...
<head>
    <meta charset="utf-8">
    <title>VnesZBrand|Registrasi</title>
