...
<head>
    <meta charset="utf-8">
    <title>VnesZInfluencer|Profil</title>
            ...
            <h4><span>Profil</span></h4>
                ...
                <div class="row justify-content center">
                    <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image">p</div> -->
                     ...
                     <img class="w-100" src="gambar/<?= $akun_influencer['foto_profil'];?>" alt=""  height="300">
                     ...
                     <table class="table table-bordered text-left text-dark mt-small-3">
                        <tr>
                            ...
                            <th>:</th>
                            <td><?= $akun_influencer['nama_influencer'];?></td>
                        </tr>
                        <tr>
                            <th>Username</th>
                            <th>:</th>
                            <td><?= $akun_influencer['username'];?></td>
                        </tr>
                        <tr>
                            <th>Password</th>
                            <th>:</th>
                            <td><?= $akun_influencer['password'];?></td>
                        </tr>
                        <tr>
                            <th>Email</th>
                            <th>:</th>
                            <td><?= $akun_influencer['email'];?></td>
                        </tr>
                        <tr>
                            <th>Nomor Telepon</th>
                            <th>:</th>
                            <td><?= $akun_influencer['nomor_telepon'];?></td>
                        </tr>
                         <tr>
                            <td  colspan="3">Media Sosial</td>
                        </tr>
                        <tr>
                           <td colspan="3" class="align-middle"><div>Instagram</div><img src="../img/iconinstagram.png" alt="Image" width="50" height="50">
                                <?= $akun_influencer['sosmed_instagram'];?> | Followers : <?= $akun_influencer['pengikut_sosmed_instagram'];?>
                                
                            </td>
                        </tr>
                         <tr>
                            <td colspan="3" class="align-middle"><div>TikTok</div><img src="../img/icontiktok.png" alt="Image" width="50" height="50">
                                <?= $akun_influencer['sosmed_tiktok'];?> | Followers : <?= $akun_influencer['pengikut_sosmed_tiktok'];?>
                        ...
                        <tr>
                            <td colspan="3" class="align-middle"><div>Facebook</div><img src="../img/iconfacebook.png" alt="Image" width="50" height="50">
                                <?= $akun_influencer['sosmed_facebook'];?> | Followers : <?= $akun_influencer['pengikut_sosmed_facebook'];?>
                ...
                <div class="row">
                    ...
                    <button type="button" name="edit" class="btn btn-success rounded mr-5" style="font-size: 15px;font-weight:bold;" onclick="window.location='riwayattransaksi.php';"><i class="fa fa-credit-card"></i> Saldo & Riwayat Transaksi</button>
