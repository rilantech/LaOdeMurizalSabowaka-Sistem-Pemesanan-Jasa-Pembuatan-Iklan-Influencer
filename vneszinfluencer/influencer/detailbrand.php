...
session_start();
  ...
  if(isset($_GET['id'])){
    $result = mysqli_query($db, "SELECT * FROM tabel_akun_brand where id_brand = '".$_GET['id']."'");
    $data_brand = mysqli_fetch_array($result);
  }
...
<head>
    <meta charset="utf-8">
    <title>VnesZInfluencer|Detail Brand</title>
...
<body>
    ...
    <div class="col-lg-12">
            <div class="text-center mb-4">
                <h4><span class="px-2">Detail Brand</span></h4>
            </div>
        </div>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border mb-3">
                        <div class="carousel-item active">
                            <img class="w-100" src="../brand/gambar/<?=$data_brand['foto_profil'];?>" alt="Image" height="250">
                        </div>
                    </div>
                      <button class="btn btn-primary py-2 px-4 mb-4 rounded" type="button" id="sendMessageButton" onclick="window.location='daftarbrand.php';"><i class="fa fa-arrow-left"></i> Kembali</button>
                </div>
            </div>
            ...
            <div class="col-lg-7 pb-2">
                 <table class="table table-bordered text-left text-dark mt-small-3">
                        <tr>
                            ...
                            <th>:</th>
                            <td><?= $data_brand['nama_brand'];?></td>
                        </tr>
                        <tr>
                            <th>Email</th>
                            <th>:</th>
                            <td><?= $data_brand['email'];?></td>
                        </tr>
                        <tr>
                            <th>Nomor Telepon</th>
                            <th>:</th>
                            <td><?= $data_brand['nomor_telepon'];?></td>
                        </tr>
                    </table>
