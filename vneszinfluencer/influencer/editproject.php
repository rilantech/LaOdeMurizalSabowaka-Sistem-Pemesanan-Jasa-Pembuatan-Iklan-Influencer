                ...
                <div class="row justify-content center">
                    <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image">p</div> -->
                     <div class="col-lg-4 content-conter">
                        ...
                        <input type="text" class="form-control form-control-user"
                                        id="username" 
                                        name= "id" placeholder="Masukan Nama Project..." value="<?= $data_project['id'];?>" hidden>
                    ...
                    <div class="col-lg-8 content-conter">
                        <div class="p-2 justify-content-center">
                                ...
                                <textarea class="form-control" rows="6" id="message" placeholder="Masukan Kriteria Project..." name="kriteria_project" value="<?= $data_project['kriteria_project'];?>"><?= $data_project['kriteria_project'];?></textarea>  
                            </div>
