...
session_start();
  ...
  $akun_influencer = mysqli_fetch_array($result);
    ...
    if(isset($_POST['edit'])){
            ...
            $_SESSION['username_influencer'] = $username;
            $_SESSION['password_influencer'] = $password;
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
              ...
              $query = "UPDATE tabel_akun_influencer SET foto_profil='$foto_profil', nama_influencer='$nama_influencer', username='$username', password='$password', email='$email', nomor_telepon='$nomor_telepon',
               sosmed_tiktok='$sosmed_tiktok', pengikut_sosmed_tiktok='$pengikut_sosmed_tiktok', sosmed_tiktok='$sosmed_tiktok', pengikut_sosmed_instagram='$pengikut_sosmed_instagram', 
                ...
                <div class="row justify-content center">
                    <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image">p</div> -->
                     <div class="col-lg-4 content-conter">
                        ...
                        <input type="text" class="form-control form-control-user"
                                        id="username" 
                                        name= "id" placeholder="Masukan Nama Project..." value="<?= $akun_influencer['id_influencer'];?>" hidden>
                            <div class="form-group">
                            <label class="mt-2">Foto Profil Lama</label>
                            <img class="form-control w-100" src="gambar/<?= $akun_influencer['foto_profil'];?>" alt="" style="height: 100px;">
                            </div>
                    ...
                    <div class="col-lg-8 content-conter">
                        <div class="p-2 justify-content-center">
                                <div class="form-group">
                                <label>Nama Influencer</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username" 
                                        name= "nama_influencer" placeholder="Masukan Nama Influencer..." value="<?= $akun_influencer['nama_influencer'];?>">
                                    </div>
                                ...
                                <label>Username</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username" 
                                        name= "username" placeholder="Masukan Username..." value="<?= $akun_influencer['username'];?>">
                                    </div>
                                ...
                                <label>Password</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username" 
                                        name= "password" placeholder="Masukan Password..." value="<?= $akun_influencer['password'];?>">
                                    </div>
                                <div class="form-group">
                                <label>Email</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "email" placeholder="Masukan Email..." value="<?= $akun_influencer['email'];?>">
                                    </div>
                                    <div class="form-group">
                                <label>Nomor Telepon</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "nomor_telepon" placeholder="Masukan Nomor Telepon..." value="<?= $akun_influencer['nomor_telepon'];?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "sosmed_instagram" placeholder="Masukan Akun Instagram..." value="<?= $akun_influencer['sosmed_instagram'];?>">
                                        </div>
                                        <div class="col-5">
                                    <label>Jumlah Follower</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "pengikut_sosmed_instagram" placeholder="Jumlah Follower..." value="<?= $akun_influencer['pengikut_sosmed_instagram'];?>">
                                        </div>
                                    ...
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "sosmed_tiktok" placeholder="Masukan Akun TikTok..." value="<?= $akun_influencer['sosmed_tiktok'];?>">
                                        </div>
                                        <div class="col-5">
                                    <label>Jumlah Follower</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "pengikut_sosmed_tiktok" placeholder="Jumlah Follower..." value="<?= $akun_influencer['pengikut_sosmed_tiktok'];?>">
                                        </div>
                                    ...
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "sosmed_facebook" placeholder="Masukan Akun Facebook..." value="<?= $akun_influencer['sosmed_facebook'];?>">
                                        </div>
                                        <div class="col-5">
                                    <label>Jumlah Follower</label>
                                    <input type="text" class="form-control form-control-user"
                                        id="username"
                                        name= "pengikut_sosmed_facebook" placeholder="Jumlah Follower..." value="<?= $akun_influencer['pengikut_sosmed_facebook'];?>">
                                        </div>
