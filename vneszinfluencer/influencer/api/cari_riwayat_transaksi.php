<?php
  ...
  $sql = "SELECT * FROM tabel_progress_project WHERE nama_project LIKE '%".$_POST['cari_transaksi']."%' AND nama_influencer='".$_POST['nama_influencer']."' AND status_project='Dibayar' order by waktu_pembayaran desc";
