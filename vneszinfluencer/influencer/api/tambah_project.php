<?php
  ...
  $gaji_influencer = $_POST['gaji_influencer'];
    ...
    if(isset($_POST['nama_brand'])){
      ...
      $select = "INSERT INTO tabel_project (waktu_posting, logo_brand, nama_brand, nama_project, kategori, kriteria_project, gaji_influencer) 
                VALUES ('$waktu_posting', '$imageStore', '$nama_brand', '$nama_project' , '$kategori', '$kriteria_project', '$gaji_influencer')";
