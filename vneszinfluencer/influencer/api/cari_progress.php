<?php
  ...
  $sql = "SELECT * FROM tabel_progress_project WHERE nama_project LIKE '%".$_POST['cari_progress']."%' AND nama_influencer='".$_POST['nama_influencer']."' order by id_progress desc";
