  ...
  $akun_brand = mysqli_fetch_array($result);
    ...
    if(isset($_POST['simpan'])){
            ...
            $userInput = array(
              ...
              if($nama_project == "" and $kategori == "" and $kriteria_project == "" and $gaji_influencer == "") {
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
              ...
              $query = "INSERT INTO tabel_project (waktu_posting, logo_brand, nama_brand, nama_project, kategori, kriteria_project, gaji_influencer) VALUES ('$time', '$logo_brand', '".$akun_brand['nama_brand']."', '$nama_project', '$kategori', '$kriteria_project', '$gaji_influencer')";
    ...
    <div class="container-fluid" style="background-color: #009688;">
        <div class="row align-items-center py-1 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="">
                    <span class="badge text-white">PT ASUS</span>
                    <a href="#" class=" dropdown-toggle" data-toggle="dropdown"> <img class="rounded-circle" alt="avatar1" src="gambar/670.png" width="50" height="50"/></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-0" style="background-color:rgba(185, 228, 175, 0.82);">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="index.html" class="nav-item nav-link active">Project</a>
                            <a href="shop.html" class="nav-item nav-link">Progress</a>
                            <a href="daftarbrand.php" class="nav-item nav-link">Daftar Brand</a>
                            <a href="detail.html" class="nav-item nav-link">Profil</a>
                        </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="col-lg-8 content-conter">
                        <div class="p-2 justify-content-center">
                                ...
                                ?>
                                     ...
                                     <div class="form-group">
                                <label>Kriteria Project</label>
                                <textarea class="form-control" rows="6" id="message" placeholder="Masukan Kriteria Project..." name="kriteria_project" value="<?= isset($kriteria_project) ? $kriteria_project : '' ?>"><?= isset($kriteria_project) ? $kriteria_project : '' ?></textarea>
                                <?php
                                    // jika terdapat error
