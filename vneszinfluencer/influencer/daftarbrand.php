...
if(isset($_POST['cari_project'])){
    ...
    $result2 = mysqli_query($db, "SELECT * FROM tabel_akun_brand");
    $jumlah_data = mysqli_num_rows($result2);
    $total_halaman = ceil($jumlah_data / $batas);

    $databrand = mysqli_query($db, "SELECT * FROM tabel_akun_brand where nama_brand LIKE '%".$_POST['cari_project']."%' ORDER by id_brand DESC limit $halaman_awal, $batas");
    ...
    $databrand = mysqli_query($db, "SELECT * FROM tabel_akun_brand ORDER by id_brand DESC limit $halaman_awal, $batas");
    $nomor = $halaman_awal+1;
}
...
<head>
    <meta charset="utf-8">
    <title>VnesZInfluencer|Daftar Brand</title>
    ...
    <div class="container-fluid" style="background-color:#009688;">
        <div class="row align-items-center py-1 px-xl-5">
            ...
            <div class="col-lg-6 col-6 text-left">
                <form action="daftarbrand.php" method="post">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari Brand..." name="cari_project" value="<?= $cari_project;?>">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-0" style="background-color:rgba(185, 228, 175, 0.82);">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="daftarbrand.php" class="nav-item nav-link active">Daftar Brand</a>
        ...
        <div class="col-lg-12">
            ...
            ?>
             <div class="text-center mb-6">
                <h3><span class="px-2">Daftar Brand</span></h3>
            </div>
            <div class="row px-xl-5 pb-3 pt-5">
            <?php while($data_brand = mysqli_fetch_array($databrand)) { ?>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        ...
                        <img class="img-fluid w-100" src="../brand/gambar/<?= $data_brand['foto_profil'];?>" alt="" style="height: 150px;">
        
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-1 pb-1">
                        
                        <h6 style="font-weight: bold;"><?= $data_brand['nama_brand'];?></h6>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="detailbrand.php?id=<?= $data_brand['id_brand'];?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Detail</a>
                    </div>
                </div>
            </div>
            <?php } ?>
