...
<head>
    <meta charset="utf-8">
    <title>VnesZInfluencer|Detail Transaksi</title>
...
<body>
    ...
    <div class="container-fluid pt-5 py-5 col-lg-10 col-small-12">
        <div class="card border-0 shadow-lg my-0 bg-primary">
            <div class="card-body">
            <h4 class="mb-3"><span>Detail Riwayat Transaksi</span></h4>
                <!-- Nested Row within Card Body -->
                <div class="row justify-content center">
                    <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image">p</div> -->
                     <div class="col-lg-3 col-small-3">
                     <img class="w-100" src="../brand/gambar/<?= $data_progress_project['struk_bukti_pembayaran'];?>" alt=""  height="300">
                     <button type="button" class="btn btn-warning rounded w-100 mb-3 mt-3" style="font-size: 15px;font-weight:bold;" onclick="window.location='../brand/gambar/<?= $data_progress_project['struk_bukti_pembayaran'];?>';" target="_blank"><i class="fa fa-zoom"></i> Perbesar</button>
                     </div>
                     <div class="col-lg-9 col-small-9">
                     <table class="table table-bordered text-left text-dark mt-small-3" style="height: 300px;">
                        <tr>
                            <th style="width: 200px;">Tanggal Transaksi</th>
                            <th style="width: 100px;">:</th>
                            <td><?= $data_progress_project['waktu_pembayaran'];?></td>
                        </tr>
                        <tr>
                            <th>Nama Project</th>
                            <th>:</th>
                            <td><?= $data_progress_project['nama_project'];?></td>
                        </tr>
                        <tr>
                            <th>Nama Brand</th>
                            <th>:</th>
                            <td><?= $data_progress_project['nama_brand'];?></td>
                        </tr>
                        <tr>
                            <th>Jumlah Gaji</th>
                            <th>:</th>
                            <td>Rp <?= number_format($data_progress_project['gaji_influencer'], 0, ',', '.'); ?></td>
                        </tr>
                    </table>
                     </div>
                ...
                <div class="row">
                    ...
                    <button type="button" name="edit" class="btn btn-success rounded mr-5" style="font-size: 15px;font-weight:bold;" onclick="window.location='riwayattransaksi.php';"><i class="fa fa-arrow-left"></i> Kembali</button>
                </div>
                </form>
