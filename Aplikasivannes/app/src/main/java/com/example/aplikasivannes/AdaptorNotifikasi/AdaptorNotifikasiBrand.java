...
public class AdaptorNotifikasiBrand extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    ArrayList<GetNotifikasiBrand> model;
    public static String id_progress1, id_hapus_progress;
    public AdaptorNotifikasiBrand(Context context2, ArrayList<GetNotifikasiBrand> model2) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        Button btnLihat;
        View view1 = this.inflater.inflate(R.layout.list_notifikasi_brand, (ViewGroup) null);
        if (view1 != null) {
            ...
            btnLihat = view1.findViewById(R.id.btnLihat);
               ...
               tvNama_Pengirim.setText(model.get(position).getNama_influencer());
            ...
            btnLihat.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    AdaptorProgressBrand.id_progress ="";
