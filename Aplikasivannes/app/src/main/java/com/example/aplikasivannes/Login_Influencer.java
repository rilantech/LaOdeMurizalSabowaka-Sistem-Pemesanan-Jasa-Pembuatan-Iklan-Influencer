...
public class Login_Influencer extends AppCompatActivity {
    ...
    public static String id, nama_influencer, username, password, foto_profil, email, nomor_telepon, sosmed_tiktok, pengikut_sosmed_tiktok,sosmed_instagram, pengikut_sosmed_instagram, sosmed_facebook, pengikut_sosmed_facebook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), Registrasi_Influencer.class));
                finish();
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(etPassword.getText().toString().length() ==0){
                    ...
                    String url = new Configurasi().baseUrl()+"influencer/api/login.php";
                    ...
                    StringRequest stringRequest = new StringRequest(
                            ...
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        {
                                            saveInfo(jsonObject);
                                            AlertDialog.Builder builder = new AlertDialog.Builder(Login_Influencer.this);
                                            builder.setTitle("Sukses");
                                            builder.setMessage("Berhasil Login");
                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    Intent intent = new Intent(Login_Influencer.this, Halaman_Utama_Influencer.class);
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(Login_Influencer.this, "Anda Sedang Offline!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ){
                        @Override
...
//                Toast.makeText(Login_Influencer.this, response.toString(), Toast.LENGTH_SHORT).show();
                preferenceHelper.putIsLogin(true);
                try {
                    id = response.getString("id");
                    nama_influencer = response.getString("nama_influencer");
                    username = response.getString("username");
                    password = response.getString("password");
                    foto_profil = response.getString("foto_profil");
                    email = response.getString("email");
                    nomor_telepon = response.getString("nomor_telepon");
                    sosmed_tiktok = response.getString("sosmed_tiktok");
                    pengikut_sosmed_tiktok = response.getString("pengikut_sosmed_tiktok");
                    sosmed_instagram = response.getString("sosmed_instagram");
                    pengikut_sosmed_instagram = response.getString("pengikut_sosmed_instagram");
                    sosmed_facebook = response.getString("sosmed_facebook");
                    pengikut_sosmed_facebook = response.getString("pengikut_sosmed_facebook");

                    preferenceHelper.putNama(nama_influencer);
