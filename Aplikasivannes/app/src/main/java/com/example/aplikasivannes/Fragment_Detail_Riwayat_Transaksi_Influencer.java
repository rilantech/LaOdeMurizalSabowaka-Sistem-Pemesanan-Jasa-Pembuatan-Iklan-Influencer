...
public class Fragment_Detail_Riwayat_Transaksi_Influencer extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_detail_riwayat_transaksi_influencer, container, false);
            ...
            String urlgambar = new Configurasi().baseUrl()+"brand/gambar/"+ Fragment_Riwayat_Transaksi_Influencer.struk_pembayaran;
            ...
            tvTanggal_Transaksi.setText(Fragment_Riwayat_Transaksi_Influencer.tanggal_transaksi);
            tvNama_Project.setText(Fragment_Riwayat_Transaksi_Influencer.nama_project);
            tvNama_Brand.setText(Fragment_Riwayat_Transaksi_Influencer.nama_brand);
            tvJumlah_Transaksi.setText(Fragment_Riwayat_Transaksi_Influencer.jumlah_transaksi);
